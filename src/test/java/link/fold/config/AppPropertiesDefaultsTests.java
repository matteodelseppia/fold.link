...
/**
 * Confirms the real application.yml resolves app.alias.* and
 * app.redis.key-prefix to their ADR-matching defaults when the
 * corresponding environment variables aren't set, using the local profile
 * (which only supplies REDIS_HOST/APP_BASE_URL defaults, nothing for
 * alias/redis).
 */
