...
/** The staging profile requires REDIS_HOST/APP_BASE_URL to come from the environment; no hosted endpoint is committed. */
...
class StagingProfileConfigTests {
    ...
    void bindsUsingFixtureEnvironmentVariables() {
        assertThat(env.getProperty("spring.data.redis.host")).isEqualTo("fixture-staging-redis.internal");
