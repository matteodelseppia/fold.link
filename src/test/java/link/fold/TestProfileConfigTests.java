...
/**
 * application-test.yml lives under src/test/resources only, so it is never packaged into the
 * application artifact and can never be activated against a real deployment.
 */
