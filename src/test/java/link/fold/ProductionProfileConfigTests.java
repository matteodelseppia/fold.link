...
/**
 * The production profile requires REDIS_HOST/APP_BASE_URL to come from the
 * environment; it binds to whatever fixture is supplied here and never to a
 * value shared with the staging test, proving the profiles can't cross over.
 */
...
class ProductionProfileConfigTests {
    ...
    void bindsUsingFixtureEnvironmentVariables() {
        assertThat(env.getProperty("spring.data.redis.host")).isEqualTo("fixture-production-redis.internal");
