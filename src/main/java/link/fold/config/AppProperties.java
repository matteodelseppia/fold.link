...
@Validated
public record AppProperties(@NotBlank @URL String baseUrl, @Valid Alias alias, @Valid Redis redis) {

  public record Alias(@Min(6) @Max(32) int length, @Min(1) @Max(20) int retryCount) {
